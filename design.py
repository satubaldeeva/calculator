...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QIcon()
        icon.addFile(u":/icons/calculate_FILL0_wght400_GRAD0_opsz48.png", QSize(), QIcon.Normal, QIcon.Off)
...
"}")
        ...
        self.l_e = QLineEdit(self.centralwidget)
        self.l_e.setObjectName(u"l_e")
        sizePolicy1 = QSizePolicy(QSizePolicy.Expanding, QSizePolicy.Maximum)
        sizePolicy1.setHorizontalStretch(0)
        sizePolicy1.setVerticalStretch(0)
        sizePolicy1.setHeightForWidth(self.l_e.sizePolicy().hasHeightForWidth())
        self.l_e.setSizePolicy(sizePolicy1)
        self.l_e.setStyleSheet(u"font-size:40pt;\n"
"border:none;")
        self.l_e.setMaxLength(10)
        self.l_e.setAlignment(Qt.AlignRight|Qt.AlignTrailing|Qt.AlignVCenter)
        self.l_e.setReadOnly(True)

        self.verticalLayout.addWidget(self.l_e)
        ...
        self.layout_buttons.addWidget(self.btn_res, 4, 3, 1, 1)
        ...
        self.btn_plus_min = QPushButton(self.centralwidget)
        self.btn_plus_min.setObjectName(u"btn_plus_min")
        sizePolicy2.setHeightForWidth(self.btn_plus_min.sizePolicy().hasHeightForWidth())
        self.btn_plus_min.setSizePolicy(sizePolicy2)

        self.layout_buttons.addWidget(self.btn_plus_min, 4, 0, 1, 1)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/backspace-arrow.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.l_e.setText(QCoreApplication.translate("MainWindow", u"0", None))
...
#if QT_CONFIG(shortcut)
        self.btn_res.setShortcut(QCoreApplication.translate("MainWindow", u"=", None))
#endif // QT_CONFIG(shortcut)
        ...
        self.btn_plus_min.setText(QCoreApplication.translate("MainWindow", u"+/-", None))
